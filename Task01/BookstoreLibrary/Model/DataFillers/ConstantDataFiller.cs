...
namespace BookstoreLibrary
{
	public class ConstantDataFiller : IDataFiller
	{
		public void Fill(DataContext dataContext)
		{
			...
			dataContext.Books.Add(1, new Book("Harry Potter and the Half-Blook Prince", "Rowling", 2005));
			dataContext.Books.Add(1, new Book("Marley & Me", "Grogan", 2005));
			dataContext.Books.Add(1, new Book("Feast", "Masterton", 1988));
